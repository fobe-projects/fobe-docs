...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2101-1a.digram.png" alt="FoBE Base with Solar Power Hardware Diagram" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2101-1a.dimensions.png" alt="FoBE Base with Solar Power Mechanical Dimensions" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
