---
title: Quick Start with FoBE Quill nRF52840 Mesh
sidebar_label: Quick Start
keywords: [FoBE Quill nRF52840 Mesh, nRF52840, SX1262, Quick Start, Getting Started, Setup, Arduino, PlatformIO, MicroPython, CircuitPython, Zephyr, LoRa, Bluetooth, Mesh Network, IoT, USB-C]
---
