---
title: Applications of FoBE Quill nRF52840 Mesh
sidebar_label: Applications
keywords: [FoBE Quill nRF52840 Mesh, Meshtastic, Mesh Network, LoRa, Bluetooth, Zigbee, Thread, IEEE 802.15.4, nRF52840, SX1262, Development Board, IoT, Wireless, Open Source, Firmware, Flashing, Setup, Guide, Nordic, Semtech, Off-grid, Decentralized, Python, USB-C, Battery]
---
