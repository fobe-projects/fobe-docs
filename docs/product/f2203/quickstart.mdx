...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2203-1a.digram.png" alt="FoBE Breakout OLED 0.42 inch Hardware Diagram" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2203-1a.dimensions.png" alt="FoBE Breakout OLED 0.42 inch Mechanical Dimensions" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2203-1a.connection.png" alt="FoBE Breakout L76K Mechanical connection" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
