...
|Interface                           |Description |
|-------------------------------|---------|
|JP1 |Soldering this pad configures the module to use GPS + GLONASS. By default, the pad is not soldered, and the module uses BeiDou + GPS. |
|JP2 |The PPS (Pulse Per Second) LED jumper. To save power, you can physically cut the trace between the pads of this jumper. You can later re-solder the jumper to reconnect the PPS LED. |
...
- PPS-PULSE: Outputs a pulse per second, works concurrently with the PPS LED, and is not affected by JP2.
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2207-1a.connection.png" alt="FoBE Breakout L76K Mechanical connection" style={{ width: '100%', height: 'auto' }} />
</div>
<br/>
