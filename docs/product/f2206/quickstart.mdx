...
image: /img/products/f2206-r1a.main.webp
...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2206-r1a.main.webp" alt="FoBE Breakout AS5600 Main" style={{ width: '320px', height: 'auto' }} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2206-r1a.digram.webp" alt="FoBE Breakout AS5600 Hardware Diagram" style={{ width: '80%', height: 'auto' }} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2206-r1a.dimensions.webp" alt="FoBE Breakout AS5600 Mechanical Dimensions" style={{ width: '80%', height: 'auto' }} />
</div>
...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/breakout-debugger-connection.webp" alt="FoBE Breakout AS5600 Connection" style={{ width: '80%', height: 'auto' }} />
</div>
