...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2206-1a.digram.png" alt="FoBE Breakout AS5600 Hardware Diagram" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2206-1a.dimensions.png" alt="FoBE Breakout AS5600 Mechanical Dimensions" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2206-1a.connection.png" alt="FoBE Breakout AS5600 Mechanical connection" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
