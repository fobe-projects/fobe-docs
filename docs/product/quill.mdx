---
title: Quill Series
description: Overview of the FoBE Quill Series.
sidebar_label: Quill Series
image: /img/apps/fobe.quill.banner.webp
slug: /quill_series
...
<div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
    <img src="/img/apps/fobe.quill.banner.webp" alt="FoBE Quill series" style={{ width: '192px', height: 'auto', borderRadius: '10px', maxWidth: '320px'}} />
</div>
<br/>
    ...
    <tbody>
        <tr>
            ...
            <td style={{ fontWeight: 'bold' }} >
              <Link to="/quill_nrf52840_mesh_getting_started">FoBE Quill nRF52840 Mesh</Link>
            </td>
            <td style={{ fontWeight: 'bold' }} >
              <Link to="/quill_esp32s3_mesh_getting_started">FoBE Quill ESP32S3 Mesh</Link>
            </td>
        </tr>
        <tr>
            <td>SKU</td>
