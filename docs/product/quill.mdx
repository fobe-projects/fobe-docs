...
image: /img/apps/fobe.quill.banner.png
slug: /quill_series
...
<div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
    <img src="/img/apps/fobe.quill.banner.png" alt="FoBE Quill series" style={{ width: '192px', height: 'auto', borderRadius: '10px', maxWidth: '320px'}} />
</div>
<br/>
