---
title: Quick Start with FoBE Quill ESP32S3 Mesh
sidebar_label: Quick Start
keywords: [FoBE Quill ESP32S3 Mesh, ESP32-S3, SX1262, Quick Start, Getting Started, Setup, Arduino, PlatformIO, MicroPython, CircuitPython, Zephyr, LoRa, Bluetooth, Wi-Fi, Mesh Network, IoT, USB-C]
---
