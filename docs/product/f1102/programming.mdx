...
:::
    ...
    1. Download the latest firmware file with the `.bin` extension.
    2. Connect the FoBE Quill ESP32S3 Mesh to your computer using a USB-C cable.
    ...
    write-flash --flash-mode dio --flash-size 4MB --flash-freq 80m 0x0 [firmware].bin
    ```
...
Before you start, make sure you have Python installed on your system.
    ...
    */
    ...
    Put the device into bootloader mode (hold the BOOT button while pressing RESET), then run the following commands in the terminal:
