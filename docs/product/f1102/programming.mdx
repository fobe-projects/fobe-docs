...
### Add Platform repository
    ...
    3. Input the git repository url ```https://github.com/fobe-projects/fobe-nrf52-platformio.git#develop``` then click "Install" button, waiting for installation done.
...
Before you start, make sure you have Python installed on your system.
    ...
    That you can got a simple LED blinking example (Zephyr RTOS Standalone project) running on the **FoBE Quill nRF52840 Mesh**.
    ...
    Or you can explore the [FoBE Zephyr](https://github.com/fobe-projects/fobe-zephyr) for more details on using the **FoBE Zephyr SDK**.