...
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2209-1a.digram.png" alt="FoBE Breakout GP8303 Hardware Diagram" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2209-1a.dimensions.png" alt="FoBE Breakout GP8303 Mechanical Dimensions" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
...
<br/>
<div style={{ textAlign: 'center' }}>
  <img src="/img/products/f2209-1a.connection.png" alt="FoBE Breakout GP8303 Mechanical connection" style={{ width: '80%', height: 'auto' }} />
</div>
<br/>
