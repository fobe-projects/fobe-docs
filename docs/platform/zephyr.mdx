...
title: Zephyr
sidebarLabel: Zephyr
keywords: [Zephyr, RTOS, Real-Time Operating System, FoBE, SDK, Microcontroller, Firmware, ESP32, nRF52840, Mesh, Open Source, Development Board, Quickstart, Install]
hide_title: true
---
