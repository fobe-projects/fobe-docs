...
keywords: [CircuitPython, FoBE, Python, Microcontroller, Firmware, ESP32, nRF52840, Mesh, Open Source, Development Board, Quickstart, Install]
hide_title: true
---
...
More information about the CircuitPython REPL can be found in the [CircuitPython documentation](https://learn.adafruit.com/welcome-to-circuitpython/the-repl).
