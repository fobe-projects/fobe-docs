...
<Block title="Solutions" >
    <Chapters>
        [<Earth size={16} strokeWidth={1.5}/> **Environmental Telemetry** _Build reliable environmental monitoring systems with MicroPython._](solution/telemetry)

        [<MessageSquareQuote size={16} strokeWidth={1.5}/> **Meshtastic** _Build popular Meshtastic hardware devices._](solution/meshtastic)
